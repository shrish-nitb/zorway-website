    ...
    <>
      <div className="navMenu">
        <div className="nav-item-container navbar-font">
          ...
          <div className="item"><Link to="/service" style={{ display: "flex", alignItems: "center" }}>Services &nbsp;
          ...
          <div className="item"><Link to="/testimonial">Testimonial</Link></div>
          <div className="item"><Link to="/blogs">Blog</Link></div>
